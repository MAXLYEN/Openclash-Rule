...
| Meta / Muse、Llama、Facebook、Instagram、WhatsApp、Threads、Messenger、Oculus | `meta.ai`（含 `dev.meta.ai`、`api.meta.ai`）、`muse.ai`（含 `auth.muse.ai`）、`meta.com`、`llama.com` 与各产品一方主域 | USNet | [Meta Model API 主机名](https://dev.meta.ai/docs/overview)、[Muse 官方入口与美国首发公告](https://about.fb.com/news/2026/09/introducing-muse-personal-ai-agent/)、[API 地区说明](https://dev.meta.ai/help/accounts-and-login/supported-countries)；美国出口 |
